...
#   RegistrationStore / EnrollmentCodeStore / agents.json I/O / TokenIssuer（1044-1569）
#   load_agents_config / admin 鉴权辅助（1792-1904）
#   ApiHandler._read_body + _json/_json_error + 全部注册端点（2074-2095、2173-2724）
...
COVERAGE_SCOPE_RANGES = [
    (1044, 1573),  # RegistrationStore / EnrollmentCodeStore / agents.json I/O / TokenIssuer
    (1798, 1958),  # load_agents_config / ensure_admin_config / load_admin_config / load_projects_config / register_project_in_config / 鉴权辅助（TASK-069）
    (2132, 2154),  # ApiHandler._read_body（注册端点读体依赖）
    (2231, 2804),  # _json / _json_error / _register ~ _read_body_json（全部注册端点 + TASK-069 自动登记）
]
